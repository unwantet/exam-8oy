...
const navigateLink = () => {
  ...
  return (
    <div  class="card">
      <div class="top-section" style={{ backgroundImage: `url(${product.img[0]})` }} >
      ...
      <div class="bottom-section cursor-pointer" onClick={navigateLink}>
        ...
        <div class="row row1">
          <div class="item">
            <span class="big-text">{product.cockingTime} min</span>
            <span class="regular-text">Cooking Time</span>
          </div>
          <div class="item">
            <span class="big-text">$ {product.price}</span>
            <span class="regular-text">Price</span>
          </div>
        </div>
      </div>
    </div>
